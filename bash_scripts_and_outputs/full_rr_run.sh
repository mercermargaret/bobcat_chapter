...
if [ -f results/results_rr.csv ]; then
    ...
    echo "name, numb_real_crossings, numb_simulated_crossings, numb_crossings_near_structure, speed, area_sq_km, total_road_length_km, road_density)" > results/results_rr.csv
fi
