...
list=(/home/u15/mmercer3/proj/bobcat_chapter/data/Bobcat_Individuals/non_range_resident/*.csv)

date
echo "Initiating script"

Rscript analysis/model_fitting_NON_rr.R ${list[SLURM_ARRAY_TASK_ID]} # name of script
