# after merging Teddy and Wyatt, rerun entire analysis for Wyatt 2.0
# margaret mercer
# Oct 21, 2024
...
individual_gps <- read.csv("data/Bobcat_Individuals/range_resident/wyatt.csv")
...
# fix his name
individual$identity <- "Wyatt"

slot(individual, "info")$identity <- "Wyatt"
...
save(fits, individual, hr, list = c(ctmm_name, t_name, hr_name),
     file = paste0("results/Model_Fit_Results/", id, "_rr.Rda"))

print(paste0("Model saved at ",Sys.time()))
# 
# 
